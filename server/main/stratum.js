...
const Stratum = function (logger, config, configMain) {
    ...
    this.outputStratum = function () {
        ...
        const output = [
            _this.text.startingMessageText1(
                `Pool-${_this.config.primary.coin.name}`,
            ),
            ...
            _this.text.startingMessageText7(
                _this.stratum.statistics.difficulty,
            ),
            _this.text.startingMessageText8(
                _this.stratum.statistics.connections,
            ),
